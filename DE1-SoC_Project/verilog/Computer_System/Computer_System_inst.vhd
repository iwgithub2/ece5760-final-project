	component Computer_System is
		port (
			...
			mcmc_system_0_mcmc_control_best_order_packed : out   std_logic_vector(31 downto 0);                    -- best_order_packed
			mcmc_system_0_mcmc_control_best_score        : out   std_logic_vector(31 downto 0);                    -- best_score
			mcmc_system_0_mcmc_control_done              : out   std_logic;                                        -- done
			mcmc_system_0_mcmc_control_num_cands_packed  : in    std_logic_vector(31 downto 0) := (others => 'X'); -- num_cands_packed
			mcmc_system_0_mcmc_control_seed              : in    std_logic_vector(31 downto 0) := (others => 'X'); -- seed
			mcmc_system_0_mcmc_control_start             : in    std_logic                     := 'X'              -- start
		);
	...
	u0 : component Computer_System
		port map (
			...
			mcmc_system_0_mcmc_control_best_order_packed => CONNECTED_TO_mcmc_system_0_mcmc_control_best_order_packed, --         mcmc_system_0_mcmc_control.best_order_packed
			mcmc_system_0_mcmc_control_best_score        => CONNECTED_TO_mcmc_system_0_mcmc_control_best_score,        --                                   .best_score
			mcmc_system_0_mcmc_control_done              => CONNECTED_TO_mcmc_system_0_mcmc_control_done,              --                                   .done
			mcmc_system_0_mcmc_control_num_cands_packed  => CONNECTED_TO_mcmc_system_0_mcmc_control_num_cands_packed,  --                                   .num_cands_packed
			mcmc_system_0_mcmc_control_seed              => CONNECTED_TO_mcmc_system_0_mcmc_control_seed,              --                                   .seed
			mcmc_system_0_mcmc_control_start             => CONNECTED_TO_mcmc_system_0_mcmc_control_start              --                                   .start
		);
