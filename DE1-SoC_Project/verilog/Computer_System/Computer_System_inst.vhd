	component Computer_System is
		port (
			...
			onchip_sram_0_s1_address                  : in    std_logic_vector(6 downto 0)  := (others => 'X'); -- address
			onchip_sram_0_s1_clken                    : in    std_logic                     := 'X';             -- clken
			onchip_sram_0_s1_chipselect               : in    std_logic                     := 'X';             -- chipselect
			onchip_sram_0_s1_write                    : in    std_logic                     := 'X';             -- write
	...
	u0 : component Computer_System
		port map (
			...
			onchip_sram_0_s1_address                  => CONNECTED_TO_onchip_sram_0_s1_address,                  --                   onchip_sram_0_s1.address
			onchip_sram_0_s1_clken                    => CONNECTED_TO_onchip_sram_0_s1_clken,                    --                                   .clken
			onchip_sram_0_s1_chipselect               => CONNECTED_TO_onchip_sram_0_s1_chipselect,               --                                   .chipselect
			onchip_sram_0_s1_write                    => CONNECTED_TO_onchip_sram_0_s1_write,                    --                                   .write
