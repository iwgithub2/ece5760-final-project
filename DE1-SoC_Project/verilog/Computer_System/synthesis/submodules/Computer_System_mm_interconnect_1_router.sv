...
(
    ...
    localparam PAD10 = log2ceil(64'h3030 - 64'h3020); 
    localparam PAD11 = log2ceil(64'h3038 - 64'h3030); 
    // -------------------------------------------------------
    ...
    // ( 0x3020 .. 0x3030 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 14'h3020   ) begin
            src_channel = 12'b100000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x3030 .. 0x3038 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 14'h3030   ) begin
