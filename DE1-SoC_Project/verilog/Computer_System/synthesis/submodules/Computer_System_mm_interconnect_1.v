...
module Computer_System_mm_interconnect_1 (
	...
	wire  [116:0] pio_seed_s1_agent_rf_source_data;                                            // pio_seed_s1_agent:rf_source_data -> pio_seed_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] pio_seed_s1_agent_rsp_fifo_out_data;                                         // pio_seed_s1_agent_rsp_fifo:out_data -> pio_seed_s1_agent:rf_sink_data
	...
	wire  [116:0] pio_best_score_s1_agent_rf_source_data;                                      // pio_best_score_s1_agent:rf_source_data -> pio_best_score_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] pio_best_score_s1_agent_rsp_fifo_out_data;                                   // pio_best_score_s1_agent_rsp_fifo:out_data -> pio_best_score_s1_agent:rf_sink_data
	...
	wire  [115:0] pio_seed_s1_agent_rp_data;                                                   // pio_seed_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [115:0] pio_done_s1_agent_rp_data;                                                   // pio_done_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [115:0] pio_best_score_s1_agent_rp_data;                                             // pio_best_score_s1_agent:rp_data -> router_007:sink_data
	...
	wire    [6:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> pio_start_s1_burst_adapter:sink0_channel
	...
	wire    [6:0] pio_start_s1_burst_adapter_source0_channel;                                  // pio_start_s1_burst_adapter:source0_channel -> pio_start_s1_agent:cp_channel
	...
	wire  [115:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> pio_seed_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                                       // pio_seed_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [6:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> pio_seed_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] pio_seed_s1_burst_adapter_source0_data;                                      // pio_seed_s1_burst_adapter:source0_data -> pio_seed_s1_agent:cp_data
	wire          pio_seed_s1_burst_adapter_source0_ready;                                     // pio_seed_s1_agent:cp_ready -> pio_seed_s1_burst_adapter:source0_ready
	wire    [6:0] pio_seed_s1_burst_adapter_source0_channel;                                   // pio_seed_s1_burst_adapter:source0_channel -> pio_seed_s1_agent:cp_channel
	...
	wire  [115:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> pio_done_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                       // pio_done_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [6:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> pio_done_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> pio_best_score_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                       // pio_best_score_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> pio_best_score_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] pio_best_score_s1_burst_adapter_source0_data;                                // pio_best_score_s1_burst_adapter:source0_data -> pio_best_score_s1_agent:cp_data
	...
	wire    [6:0] pio_best_score_s1_burst_adapter_source0_channel;                             // pio_best_score_s1_burst_adapter:source0_channel -> pio_best_score_s1_agent:cp_channel
