	Computer_System u0 (
		...
		.mcmc_system_0_mcmc_control_best_order_packed (<connected-to-mcmc_system_0_mcmc_control_best_order_packed>), //         mcmc_system_0_mcmc_control.best_order_packed
		.mcmc_system_0_mcmc_control_best_score        (<connected-to-mcmc_system_0_mcmc_control_best_score>),        //                                   .best_score
		.mcmc_system_0_mcmc_control_done              (<connected-to-mcmc_system_0_mcmc_control_done>),              //                                   .done
		.mcmc_system_0_mcmc_control_num_cands_packed  (<connected-to-mcmc_system_0_mcmc_control_num_cands_packed>),  //                                   .num_cands_packed
		.mcmc_system_0_mcmc_control_seed              (<connected-to-mcmc_system_0_mcmc_control_seed>),              //                                   .seed
		.mcmc_system_0_mcmc_control_start             (<connected-to-mcmc_system_0_mcmc_control_start>)              //                                   .start
	);
