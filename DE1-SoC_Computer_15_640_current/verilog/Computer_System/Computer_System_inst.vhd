	component Computer_System is
		port (
			...
			onchip_sram_s1_address                         : in    std_logic_vector(6 downto 0)  := (others => 'X'); -- address
			...
			onchip_sram_s1_readdata                        : out   std_logic_vector(63 downto 0);                    -- readdata
			onchip_sram_s1_writedata                       : in    std_logic_vector(63 downto 0) := (others => 'X'); -- writedata
			onchip_sram_s1_byteenable                      : in    std_logic_vector(7 downto 0)  := (others => 'X'); -- byteenable
			...
			pio_allowed_parents_external_connection_export : out   std_logic_vector(31 downto 0);                    -- export
			pio_done_external_connection_export            : in    std_logic_vector(31 downto 0) := (others => 'X'); -- export
			pio_final_score_external_connection_export     : in    std_logic_vector(31 downto 0) := (others => 'X'); -- export
	...
	u0 : component Computer_System
		port map (
			...
			pio_allowed_parents_external_connection_export => CONNECTED_TO_pio_allowed_parents_external_connection_export, -- pio_allowed_parents_external_connection.export
			pio_done_external_connection_export            => CONNECTED_TO_pio_done_external_connection_export,            --            pio_done_external_connection.export
			pio_final_score_external_connection_export     => CONNECTED_TO_pio_final_score_external_connection_export,     --     pio_final_score_external_connection.export
